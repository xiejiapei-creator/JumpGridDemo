System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, Prefab, instantiate, Node, Vec3, PlayerController, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, BlockType, GameState, GameManager;
    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass("GameManager"), _dec2 = property({
        ...
        start() {
          ...
          (_this$playerCtrl = this.playerCtrl) == null ? void 0 : _this$playerCtrl.node.on('JumpEnd', this.onPlayerJumpEnd, this); // 重置当前角色位置

          (_this$playerCtrl2 = this.playerCtrl) == null ? void 0 : _this$playerCtrl2.reset();
        } // 初始化方法
        ...
        set curState(value) {
          switch (value) {
            ...
            case GameState.GS_PLAYING:
              ...
              console.log("dssdds"); // 设置 active 为 true 时会直接开始监听鼠标事件，此时鼠标抬起事件还未派发
...
//# sourceMappingURL=b3338d03eb4f7f108c0d8934ec23d74403036cbc.js.map